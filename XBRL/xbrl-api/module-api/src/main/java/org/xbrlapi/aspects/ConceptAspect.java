...
public class ConceptAspect extends AspectImpl implements Aspect {
     ...
     */
    public static final String ID = "http://xbrlapi.org/aspect/concept/1.0";
    ...
    /**
     * @param concept The concept to get the concept aspect value for.
     * @return the concept aspect value for this concept.
     * @throws XBRLException
     */
    public ConceptAspectValue getValue(Concept concept) throws XBRLException {
        return new ConceptAspectValue(concept.getTargetNamespace(),concept.getName());
    }
