...
public class CombinationsImpl implements Combinations {
     ...
     */
    private HashMap<String,List<AspectValue>> aspectValues = new HashMap<String,List<AspectValue>>();
    ...
    /**
     * @see Combinations#getAncestorCount(String)
     */
    public int getAncestorCount(String aspectId) throws XBRLException {
    ...
    /**
     * @see Combinations#hasAspect(String)
     */
    public boolean hasAspect(String aspectId) throws XBRLException {
        if (aspectId == null) throw new XBRLException("The aspect ID must not be null.");
        return model.axisContainsAspect(axis,aspectId);
    }

    /**
     * @see Combinations#setAspectValues(String, List)
     */
    public void setAspectValues(String aspectId, List<AspectValue> values) throws XBRLException {
    ...
    /**
     * @see Combinations#clearAspectValues(String)
     */
    public void clearAspectValues(String aspectId) throws XBRLException {
        if (! this.hasAspect(aspectId)) 
            throw new XBRLException("The aspect " + aspectId + " is not in this combination.");
    ...
    /**
     * @see Combinations#getAspectValueCount(String)
     */
    public int getAspectValueCount(String aspectId) throws XBRLException {
        return getAspectValues(aspectId).size();
    }

    /**
     * @see Combinations#getAspectValues(String)
     */
    public List<AspectValue> getAspectValues(String aspectId)
    ...
    /**
     * @see Combinations#getDescendantCount(String)
     */
    public int getDescendantCount(String aspectId) throws XBRLException {
        List<Aspect> aspects = model.getAspects(axis);
        Aspect aspect = model.getAspect(aspectId);
        int index = aspects.indexOf(aspect);
    ...
    /**
     * @see Combinations#getCombinationValue(String, int)
     */
    public AspectValue getCombinationValue(String aspectId, int combination) throws XBRLException {
     ...
     */
    public Map<String, AspectValue> getCombinationValues(int combination) throws XBRLException {
