...
public class ExplicitDimensionAspect extends DimensionAspect implements Aspect {
     ...
     * @param dimensionNamespace The namespace of the dimension.
     * @param dimensionLocalname The local name of the dimension.
     * @throws XBRLException if the ID parameter is null.
     */
    public ExplicitDimensionAspect(Domain domain, String dimensionNamespace, String dimensionLocalname) throws XBRLException {
        ...
        for (Element child: children) {
            if (child.getNamespaceURI().equals(XDTConstants.XBRLDINamespace.toString())) {
                ...
                if (! dimensionQName.equals("")) {
                    String candidateNamespace = occ.getNamespaceFromQName(dimensionQName,child);
    ...
    public ExplicitDimensionAspectValue getValue(OpenContextComponent occ, Element child) throws XBRLException {
        ...
        String memberNamespace = occ.getNamespaceFromQName(memberQName,child);
