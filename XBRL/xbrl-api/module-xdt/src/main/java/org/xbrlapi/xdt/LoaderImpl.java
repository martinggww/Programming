...
public class LoaderImpl extends org.xbrlapi.loader.LoaderImpl implements Loader, Serializable {
    ...
    /**
     * @see org.xbrlapi.loader.LoaderImpl#LoaderImpl(Store, XLinkProcessor, EntityResolver)
     */
    public LoaderImpl(Store store, XLinkProcessor xlinkProcessor, EntityResolver entityResolver) throws XBRLException {
        super(store,xlinkProcessor, entityResolver);
    }

    /**
     * @see org.xbrlapi.loader.LoaderImpl#LoaderImpl(Store, XLinkProcessor, EntityResolver, List)
     */
    public LoaderImpl(Store store, XLinkProcessor xlinkProcessor, EntityResolver entityResolver, List<URI> uris)
            throws XBRLException {
        super(store,xlinkProcessor,entityResolver, uris);
    }
