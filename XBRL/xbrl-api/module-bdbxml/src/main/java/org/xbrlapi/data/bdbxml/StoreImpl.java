...
*/
    ...
    synchronized public void persist(XML xml) throws XBRLException {
	    ...
	    try {
            ...
            String content = serialize(xml.getMetadataRootElement());
            xmlUpdateContext = dataManager.createUpdateContext();
	...
	private XmlQueryContext createQueryContext() throws XBRLException {
        ...
        try {
            ...
            for (String prefix: this.namespaceBindings.keySet()) 
                xmlQueryContext.setNamespace(prefix,this.namespaceBindings.get(prefix));
            // xmlQueryContext.setEvaluationType(XmlQueryContext.Lazy); 
     ...
     * @throws XBRLException
     */
    public void addIndex(String namespace, String name, String type) throws XBRLException {
